...
3. [`very-simple-n-neurons.md`](./very-simple-n-neurons.md): nhiều neuron cạnh nhau (output nhiều lớp hoặc hidden layer).
4. [`overview.md`](./overview.md): bức tranh tổng quan ANN (neuron, MLP, activation, giới hạn).
5. [`how-it-works.md`](./how-it-works.md): mạng biến input thành output ra sao.
6. [`how-to-train.md`](./how-to-train.md): loss, gradient descent và backpropagation.
7. [`simple-notebook-demo.md`](./simple-notebook-demo.md): chuẩn bị notebook demo.
8. [`learn-first.md`](./learn-first.md): checklist kiến thức trước khi thuyết trình.
9. [`demo-directions.md`](./demo-directions.md): kịch bản demo và hướng mở rộng web app.
...
- Khi mới bắt đầu: làm phép tính tay trong `very-simple-liner-model.md`, rồi `very-simple-ann.md` (1 neuron), rồi `very-simple-n-neurons.md` (n neuron / layer).
